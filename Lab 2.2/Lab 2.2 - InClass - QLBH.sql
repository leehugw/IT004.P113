...
where NGHD between '2007-01-01' and '2007-01-31' order by NGHD asc, TRIGIA desc;
...
--10.
select distinct CTHD.MASP, SANPHAM.TENSP from CTHD, HOADON, SANPHAM, KHACHHANG
...
--11.
select distinct HOADON.SOHD from HOADON, CTHD
where HOADON.SOHD = CTHD.SOHD and (CTHD.MASP = 'BB01' or CTHD.MASP = 'BB02');
